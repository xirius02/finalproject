...
if ($mysqli->connect_errno)
    ...
    /*if (isset($_POST['submit'])) {
        ...
        //$query4 = "update tblitem set status = '$status' where ID = '$itemid'";
...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  ...
  <body>
<div class="content2">
    <h2 style="color: white">Move Item</h2>
    <form name="form1" method="post" onsubmit="return validateForm()" >
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control col-md-4" id="status" name="status" id="status" >
